export default {
  ...
  checkpoints: [
    ...
    { id: "route", description: "Route pages by URL pattern" },
    { id: "extract", description: "Extract product data per category" },
    { id: "structure", description: "Assemble nested JSON output" },
  ],
} as const;
