...
export const dictionaries: Record<string, Dictionary> = {
  ...
  ru: {
    ...
    metadata: {
      ...
      description:
        "Интерактивный обучающий проект, разработанный для изучения веб-скрапинга через структурированные задачи, с реалистичными сценариями и автоматической проверкой решений.",
    },
    posts: {
      title: "Статьи",
    },
  ...
  es: {
    ...
    metadata: {
      ...
      description:
        "Un proyecto de aprendizaje interactivo diseñado para enseñar web scraping a través de desafíos estructurados, con escenarios realistas y verificación automática de soluciones.",
    },
    posts: {
      title: "Artículos",
    },
  ...
  zh: {
    ...
    metadata: {
      ...
      description:
        "一个交互式学习项目，旨在通过结构化的挑战教授网络爬虫，包含真实场景和自动解决方案检查。",
    },
    posts: {
      title: "文章",
    },
  ...
  ja: {
    home: {
      heading: "Housefly",
      intro:
        "Webスクレイピングは開発者にとって重要なスキルですが、学習は難しいかもしれません。だからこそ私はHouseflyを作成しました。インタラクティブな演習を通じてWebスクレイピングを教えるために設計された実践的プロジェクトです。Google Gruyereに影響を受け、Houseflyはスクレイピング用に構築された専用のサイトを伴う一連の小さなチュートリアルを提供します。目標は？あなたに安全で構造化された環境を提供し、スクレイピングスキルを練習し改良することです。",
      whyCreated: {
        title: "なぜこれを作ったのか？",
        content:
          "理論的にWebスクレイピングを説明する数多くのチュートリアルを見てきましたが、実験するための現実的で管理された環境を提供するものはほとんどありません。Houseflyは、提供されたウェブサイトをスクレイピングし、期待される出力に対して解決策を検証する自己完結型の課題を提供することで、この問題を解決します。これは、単に読むだけではなく、実際に行動したい実践的な学習者のために作られています。",
      },
      getStarted: {
        title: "始め方",
        content:
          "手順はGitHubリポジトリのREADME.mdファイルにあります。そこから、プロジェクトのセットアップと実行の手順に従ってください。",
      },
    },
    nav: {
      home: "ホーム",
    ...
    metadata: {
      ...
      description:
        "構造化された課題を通じてWebスクレイピングを教えるために設計されたインタラクティブな学習プロジェクトで、現実的なシナリオと自動解決策チェックを備えています。",
    },
    posts: {
      title: "投稿",
    },
  ...
  de: {
    ...
    metadata: {
      ...
      description:
        "Ein interaktives Lernprojekt, das Web Scraping durch strukturierte Herausforderungen lehrt, mit realistischen Szenarien und automatischer Lösungsüberprüfung.",
    },
    posts: {
      title: "Beiträge",
    },
  ...
  ro: {
    ...
    metadata: {
      ...
      description:
        "Un proiect de învățare interactiv conceput pentru a învăța web scraping prin provocări structurate, cu scenarii realiste și verificare automată a soluțiilor.",
    },
    posts: {
      title: "Articole",
    },
  ...
  hi: {
    ...
    metadata: {
      ...
      description:
        "संरचित चुनौतियों के माध्यम से वेब स्क्रैपिंग सिखाने के लिए डिज़ाइन किया गया एक इंटरैक्टिव सीखने का प्रोजेक्ट, जिसमें वास्तविक परिदृश्य और स्वचालित समाधान जांच की सुविधा है।",
    },
    posts: {
      title: "पोस्ट्स",
    },
  ...
  ta: {
    ...
    metadata: {
      ...
      description:
        "கட்டமைக்கப்பட்ட சவால்களின் மூலம் வலை ஸ்கிராப்பிங் கற்பிக்க வடிவமைக்கப்பட்ட ஒரு ஊடாடும் கற்றல் திட்டம், இதில் யதார்த்தமான காட்சிகள் மற்றும் தானியங்கி தீர்வு சரிபார்ப்பு ஆகியவை உள்ளன.",
    },
    posts: {
      title: "இடுகைகள்",
    },
  ...
  gu: {
    ...
    metadata: {
      ...
      description:
        "સંરચિત પડકારો દ્વારા વેબ સ્ક્રેપિંગ શીખવવા માટે ડિઝાઇન કરેલ ઇન્ટરેક્ટિવ શીખવાનો પ્રોજેક્ટ, જેમાં વાસ્તવિક દૃશ્યો અને સ્વચાલિત ઉકેલ તપાસ છે.",
    },
    posts: {
      title: "પોસ્ટ્સ",
    },
  ...
  fa: {
    home: {
      heading: "Housefly",
      intro:
        "وب اسکرپینگ مهارت ضروری برای برنامه‌نویسان است، اما یادگیری آن می‌تواند سخت باشد. به همین دلیل من Housefly را ساختم، یک پروژه عملی که برای آموزش وب اسکرپینگ از طریق تمرینات تعاملی طراحی شده است. با الهام از Google Gruyere، Housefly مجموعه‌ای از آموزش‌های کوچک با وب‌سایت‌های همراه اختصاصی ارائه می‌دهد که برای اسکرپ کردن ساخته شده‌اند. هدف؟ فراهم کردن محیطی امن و ساختاریافته برای تمرین و تقویت مهارت‌های اسکرپینگ شما.",
      whyCreated: {
      ...
      getStarted: {
        ...
        content:
          "دستورالعمل‌ها در فایل README.md مخزن GitHub قرار دارد. از آنجا می‌توانید مراحل تنظیم و اجرای پروژه را دنبال کنید.",
      },
    },
    nav: {
      home: "خانه",
    ...
    metadata: {
      ...
      description:
        "پروژه یادگیری تعاملی طراحی شده برای آموزش وب اسکرپینگ از طریق چالش‌های ساختاریافته، با سناریوهای واقعی و بررسی خودکار راه‌حل.",
    },
    posts: {
      title: "پست‌ها",
    },
  ...
  ur: {
    ...
    metadata: {
      ...
      description:
        "منظم چیلنجز کے ذریعے ویب اسکریپنگ سکھانے کے لیے ڈیزائن کیا گیا انٹریکٹو سیکھنے کا پروجیکٹ، جس میں حقیقی منظرنامے اور خودکار حل کی جانچ شامل ہے۔",
    },
    posts: {
      title: "پوسٹس",
    },
  ...
  ar: {
    ...
    metadata: {
      ...
      description:
        "مشروع تعلم تفاعلي مصمم لتعليم استخراج البيانات من الويب من خلال تحديات منظمة، مع سيناريوهات واقعية وفحص تلقائي للحلول.",
    },
    posts: {
      title: "المنشورات",
    },
  ...
  tr: {
    home: {
      ...
      getStarted: {
        ...
        content:
          "Talimatlar GitHub deposundaki README.md dosyasında bulunmaktadır. Oradan projeyi kurma ve çalıştırma adımlarını takip edebilirsiniz.",
      },
    },
    nav: {
      home: "Ana sayfa",
    ...
    metadata: {
      ...
      description:
        "Yapılandırılmış zorluklar, gerçekçi senaryolar ve otomatik çözüm kontrolü ile web scraping öğretmek için tasarlanmış etkileşimli öğrenme projesi.",
    },
    posts: {
      title: "Gönderiler",
    },
