...
summary: 'Learn to scrape API-driven sites, handle forms and logins, and interact with GraphQL endpoints.'
---
...
*Find a reference solution demonstrating direct API scraping in the `exercises/chapter-07/solution/src/` directory.*
