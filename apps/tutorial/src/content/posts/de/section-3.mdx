...
Leite verschiedene URLs an spezifische Handler weiter:
...
5. mit Produkten umgeht, die an mehreren Stellen erscheinen (z.B. empfohlen und Kategorie)
...
Das gelöste Beispiel in `exercises/chapter-06/solution/src/` bietet eine Referenzimplementierung mit Crawlee. Studiere es, um zu verstehen, wie man die Features der Bibliothek für effizientes mehrseitiges Crawling und Datenorganisation nutzt.
