...
* **Bilderkennung:** Verwendung von Selektoren zur Lokalisierung von Bildelementen in HTML (`<img>`-Tags, Hintergrundbilder usw.)
* **Metadaten-Extraktion:** Sammlung kritischer Informationen wie:
  * `alt`-Text (wichtig für Barrierefreiheit und die Beschreibung des Bildinhalts)
