...
1. **パフォーマンス**: 動的コンテンツのスクレイピングは静的HTMLよりも遅い
...
参考実装として、`exercises/chapter-04/solution/src/`と`exercises/chapter-05/solution/src/`の参考実装をチェックしてください。現代のウェブスクレイピングは、HTML構造とアプリケーションの振る舞いの両方を理解することが重要です。
