...
Consulta los ejemplos resueltos en `exercises/chapter-04/solution/src/` y `exercises/chapter-05/solution/src/` para implementaciones de referencia. Recuerda: el web scraping moderno consiste en entender tanto la estructura HTML como el comportamiento de la aplicación.
