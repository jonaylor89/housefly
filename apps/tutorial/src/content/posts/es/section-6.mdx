...
En este capítulo, enfrentarás "CryptoDefend Exchange", una plataforma simulada de intercambio de criptomonedas que no quiere que sus datos sean accedidos fácilmente. Como muchos sitios financieros, CryptoDefend implementa varias medidas defensivas para prevenir la recolección automática de datos de precios, volúmenes de trading y tendencias de mercado.
...
Nuestro intercambio CryptoDefend en el Capítulo 11 presenta desafíos realistas que podrías encontrar al recopilar datos financieros. Necesitarás navegar:
