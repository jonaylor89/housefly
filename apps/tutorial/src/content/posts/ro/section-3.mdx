...
Cu fundamentele atât ale scraping-ului de conținut static, cât și dinamic bine stăpânite, este timpul să abordăm o provocare mai cuprinzătoare: crawling-ul multi-pagină. Această secțiune se concentrează pe navigarea eficientă și extragerea datelor din site-uri web cu multiple pagini interconectate.
...
Exemplul rezolvat în `exercises/chapter-06/solution/src/` oferă o implementare de referință folosind Crawlee. Studiază-l pentru a înțelege cum să valorifici funcționalitățile bibliotecii pentru crawling multi-pagină eficient și organizarea datelor.
