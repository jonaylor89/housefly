...
*   **Gestionarea paginării și parametrilor:** API-urile folosesc adesea parametri de query pentru paginare (`page`, `limit`), filtrare sau sortare. Va trebui să înțelegi și să replici acești parametri în scriptul tău de scraping.
...
*Găsește o soluție de referință care demonstrează scraping-ul direct al API-ului în directorul `exercises/chapter-07/solution/src/`.*
