...
Verifică exemplele rezolvate în `exercises/chapter-04/solution/src/` și `exercises/chapter-05/solution/src/` pentru implementări de referință. Amintește-ți - web scraping-ul modern înseamnă să înțelegi atât structura HTML, cât și comportamentul aplicației.
